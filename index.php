              ...
              <div class="carousel-caption">
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="text-bg">
                      <h1>START UP NOW</h1>
                      <p>Get a discount if you are a startup business.</p>
              ...
              <div class="carousel-caption">
                ...
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="text-bg">
                      <h1>Get Started!</h1>
                      <p>CONSULTS WITH EXPERTS AND MASTERS OF BUSINESS TECHNOLOGY!</p>
                      <a href="#">Read more</a><a href="#">get a qoute</a>
                    </div>
                  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          <h2>About <strong class="yellow">UNIXON DEV</strong></h2>
  ...
  <div class="container-fluid padding_left3">
    <div class="row">
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 border_right">
        <div class="box_text">
          <div class="titlepage">
            <h2>Our <strong class="yellow"> Services</strong></h2>
          </div>
